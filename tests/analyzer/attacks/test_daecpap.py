...
def base_class(base_project: Project):
    instance = AECPA(base_project, cwa.leakage_models.sbox_output, algorithm = cwma.attacks.LAE_CPA, epoch = 3, batch_size = 500) # type: ignore
    # instance = cwa.cpa(base_project, cwa.leakage_models.sbox_output)
    return instance
